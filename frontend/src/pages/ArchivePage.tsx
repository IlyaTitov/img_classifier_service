            ...
            >
              <div className="card-thumb">
                {item.processing_complete && item.processed_filename ? (
                  <img src={processedImageUrl(item.processed_filename)} alt={item.name} className="thumb-img" loading="lazy" />
                ) : item.original_filename ? (
                  <img src={originalImageUrl(item.original_filename)} alt={item.name} className="thumb-img" loading="lazy" />
                ) : (
              ...
              <div className="card-info">
                ...
                <span className={`card-status ${item.processing_complete ? 'done' : 'pending'}`}>
                  {item.processing_complete ? 'Обработано' : 'В очереди…'}
                </span>
              </div>
              <div className="card-meta">
                <span className="det-badge">{item.detection_count} объектов</span>
              ...
              <div className="archive-card-body">
                <div className="archive-images">
                  <div className="arch-img-block">
                    ...
                    <img src={originalImageUrl(item.original_filename)} alt="Оригинал" className="arch-img" />
                  </div>
                  {item.processing_complete && item.processed_filename && (
                    <div className="arch-img-block">
                      <p className="arch-img-label">После обработки</p>
                      <img src={processedImageUrl(item.processed_filename)} alt="Обработанное" className="arch-img" />
                    </div>
                  )}
                </div>
              </div>
